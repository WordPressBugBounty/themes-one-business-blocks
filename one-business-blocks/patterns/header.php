...
<div class="wp-block-column is-vertically-aligned-center nav-block wow rubberBand" style="padding-left:var(--wp--preset--spacing--40);flex-basis:50%"><!-- wp:navigation {"textColor":"white","overlayBackgroundColor":"base","overlayTextColor":"heading","style":{"typography":{"textTransform":"uppercase","fontStyle":"normal","fontWeight":"600"}},"fontSize":"small","fontFamily":"barlow","layout":{"type":"flex","justifyContent":"center"}} -->
